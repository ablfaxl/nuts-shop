...
const Navbar = () => {
    ...
    return (
        <>
            {login && (
                <div
                    className="fixed h-full w-full bg-black transition-all duration-500 opacity-50 z-40 top-0 left-0"
                    onClick={() => setLogin(!login)}
                ></div>
            )}
            <div
                className={`fixed mx-auto top-0 left-[8.5%] w-5/6 h-full z-50 flex justify-start bg-white rounded-2xl shadow-xl items-center transition-all duration-700 ${
                    login ? "translate-y-0" : "translate-y-full"
                }`}
            >
                <LoginUser />
            </div>
                        ...
                        <ul className="flex gap-7 font-medium text-base text-[#757575] transition-all duration-500">
                            ...
                            >
                                <p
                                    className={`${
                                        flag
                                            ? "text-[#D96B14] duration-500 cursor-pointer"
                                            : null
                                    }`}
                                >
                                    Product{" "}
