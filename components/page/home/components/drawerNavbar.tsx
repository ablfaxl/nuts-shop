  ...
  const list = () => (
    <>
      <Box className={"h-[100vh] w-[522px] bg-white"}>
        ...
        <Box sx={{fontFamily:"Poppins"}} className={"w-[80%] ml-[10%] mt-[220px] gap-11  h-[200px] flex flex-col items-center "}>
            <p className="text-[20px] font-[400]">Your Basket is Empty</p>
            <p className="text-[24px] font-[800]">You Have no Item in your Card</p>
            <Button sx={{backgroundColor:"#D96B14" ,"&:hover": {backgroundColor:"#D96B14"}}} variant="contained" >Shop Now</Button>
        </Box>
      </Box>
    </>
  );
